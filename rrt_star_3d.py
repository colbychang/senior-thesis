...
class RRTStar3D(RRT3D):
    ...
    def planning(self, animation=True):
        ...
        for i in range(self.max_iter):
            ...
            d, _, _ = self.calc_distance_and_angle(near_node, new_node)
    ...
    def find_near_nodes(self, new_node):
        ...
        # expand_dist
        if hasattr(self, 'expand_dis'):  # seems useless since it always hasattr expand_dis
...
def main():
    ...
    #     (6, 12, 1),
    # ]  # [x,y,size(radius)]
    obstacle_list = [(5, 5, 3, 1), (3, 6, 2, 2), (3, 8, 5, 2), (3, 10, 4, 2), (7, 5, 7, 2),
    ...
    if path is None:
        ...
        if show_animation:
            ...
            for ox, oy, oz, r in obstacle_list:
